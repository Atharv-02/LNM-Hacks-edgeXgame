...
function App() {
  ...
  return (
    <>
      {conditionSignUp ? (
        <Modal
          disappearFucntion={setConditionSignUp}
          checkPassword={setSignUpPassword}
          elements={elementsSignUp}
          selectedArray={selectedArraySignUp}
          setSelectedArray={setSelectedArraySignUp}
        />
      ) : (
        ''
      )}
      {conditionLogin ? (
        <Modal
          disappearFucntion={setConditionLogin}
          checkPassword={setLoginPassword}
          elements={elementsLogin}
          selectedArray={selectedArrayLogin}
          setSelectedArray={setSelectedArrayLogin}
        />
      ) : (
        ''
      )}
